...
// Vive en `@agenia/shared`: el vigilante de la API tiene que clasificar igual que
// esta pantalla. Se reexporta para no cambiar los imports de quien ya lo usa.
export { derivarSync, type FilaOutbox } from '@agenia/shared';
