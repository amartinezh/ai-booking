...
/* -----------------------------------------------------------------------------
   ...
   -------------------------------------------------------------------------- */
DECLARE @CONFIRMO          bit        = 1;    -- 1 = sí, escribir. Con 0 solo valida.
DECLARE @MED_HOMOLOGADO    varchar(4) = 'AP04';   -- homologado en AgenIA, CON turno el día de prueba
DECLARE @MED_SIN_HOMOLOGAR varchar(4) = '077';   -- existe en el HIS y NO está homologado en AgenIA
DECLARE @DIAS              int        = 8;   -- día de prueba = hoy + @DIAS (dentro de lo que el bot ofrece)
...
DECLARE @TEL_PRUEBA        varchar(10) = 'PON_AQUI_TU_MOVIL';
